...
<script>
import { listProxy, createProxy, updateProxy, deleteProxy } from '@/api/vhosts'
...
export default {
  ...
  methods: {
    getList() {
      ...
      listProxy(this.listQuery).then(response => {
